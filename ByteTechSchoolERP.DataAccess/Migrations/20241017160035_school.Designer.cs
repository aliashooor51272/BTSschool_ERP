...
namespace ByteTechSchoolERP.DataAccess.Migrations
{
    ...
    [Migration("20241017160035_school")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ByteTechSchoolERP.DataAccess.HRModels.Loan", b =>
                {
                    ...
                    b.Property<decimal>("PerInstallmentAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("ByteTechSchoolERP.DataAccess.HRModels.Salary", b =>
                {
            ...
            modelBuilder.Entity("ByteTechSchoolERP.Models.HR.Employee", b =>
                {
                    b.Property<Guid>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ByteTechSchoolERP.DataAccess.HRModels.Loan", b =>
                {
                    b.HasOne("ByteTechSchoolERP.Models.HR.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ByteTechSchoolERP.DataAccess.HRModels.Staff", null)
                        .WithMany("Loans")
                        .HasForeignKey("StaffId");
